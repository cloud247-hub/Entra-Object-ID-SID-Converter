(function () {
  ...
  const elements = {
    ...
    copyPowerShellButton: document.getElementById("copy-powershell-button"),
  ...
  elements.copyPowerShellButton.addEventListener("click", () => copyText(elements.powerShellCode.textContent, "PowerShell-koden er kopiert"));
